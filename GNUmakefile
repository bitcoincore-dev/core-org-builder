...
help: test
	...
	@echo ''
	@echo '	git clone -b v0.0.7 https://github.com/bitcoincore-dev/core-org-builder.git               ~/core-org-builder'
	@echo '	git clone -b docker-builder-v0.0.7 https://github.com/bitcoincore-dev/bitcoincore.org.git ~/bitcoincore.org'
	@echo ''
...
.SILENT:
test:
	bash -c "test -e $(SITE) && echo '' || 'SITE=$(SITE) doesnt exist! && try: git clone https://github.com/bitcoin-core/bitcoincore.org ~/bitcoincore.org'"
