...
help: test
	...
	@echo ''
	@echo '	git clone -b v0.0.6 https://github.com/bitcoincore-dev/core-org-builder.git               ~/core-org-builder'
	@echo '	git clone -b docker-builder-v0.0.6 https://github.com/bitcoincore-dev/bitcoincore.org.git ~/bitcoincore.org'
	@echo ''
